...
UPDATE wp_posts SET post_content = REPLACE (post_content, 'http://site.ru', 'https://newsite');
UPDATE wp_postmeta SET meta_value = REPLACE (meta_value, 'http://site.ru','https://newsite');
